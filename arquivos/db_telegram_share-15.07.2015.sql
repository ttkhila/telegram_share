...
--
-- Servidor: localhost
-- Tempo de Geração: 15/07/2015 às 13h11min
...
CREATE TABLE IF NOT EXISTS `compartilhamentos` (
  ...
  `original1_id` int(10) unsigned DEFAULT NULL,
  `original2_id` int(10) unsigned DEFAULT NULL,
  `original3_id` int(10) unsigned DEFAULT NULL COMMENT 'FANTASMA',
...
(1, 'TEste de jogos compartilhados', 'e_rocha78@yahoo.com.br', 3, 1, 4, NULL, NULL, NULL, 2, NULL, 1, 0, 1);
...
CREATE TABLE IF NOT EXISTS `historicos` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Na criação da conta, o histórico é criado para as 3 vagas' AUTO_INCREMENT=4 ;
