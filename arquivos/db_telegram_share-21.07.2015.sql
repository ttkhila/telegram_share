...
--
-- Servidor: localhost
-- Tempo de Geração: 21/07/2015 às 13h06min
...
CREATE TABLE IF NOT EXISTS `historicos` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Na criação da conta, o histórico é criado para as 3 vagas' AUTO_INCREMENT=22 ;
...
CREATE TABLE IF NOT EXISTS `moedas` (
  ...
  `simbolo` varchar(3) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
...
(6, 'Glauber', 'airKingBR', 'airking@br.com', '', '30fb914bd667fb368bb09c312bb62b8e', 0, 1, 0),
